const cardTransaction = {
    ...
    updateTransaction(amount, type, status) {
      ...
      console.log(`Транзакция обновлена: ${type} на сумму $${amount}, статус: ${status}`);
    },
    ...
    displayTransaction() {
      if (this.transactionStatus === '') {
        ...
        console.log(`Транзакция: ${this.transactionType} на сумму $${this.amount}, статус: ${this.transactionStatus}`);
      }
    }
  };
