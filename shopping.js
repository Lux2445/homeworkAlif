const shoppingCart = {
    ...
    updateItem(name, price, quantity) {
        ...
        console.log(`Товар обновлен: ${this.itemName}, количество: ${this.itemQuantity}, цена: ${this.itemPrice}`);
    },
    ...
    displayCart() {
        if (this.itemName) {
            console.log(`Товар: ${this.itemName}, количество: ${this.itemQuantity}, цена: ${this.itemPrice}`);
        } else {
            console.log('Корзина пуста.');
        }
    }
